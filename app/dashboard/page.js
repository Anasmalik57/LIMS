...
const Dashboard = () => {
  ...
  const quickActions = [
    { name: "New Patient", icon: FiPlus, color: "blue", action: () => console.log("New patient") },
    { name: "Schedule Test", icon: FaFlask, color: "green", action: () => console.log("Schedule test") },
    { name: "View Reports", icon: FiEye, color: "purple", action: () => console.log("View reports") },
    { name: "Generate Bill", icon: FiDownload, color: "orange", action: () => console.log("Generate bill") }
  ];
            ...
            <div className="space-y-3">
              {quickActions.map((action, index) => {
                ...
                return (
                  ...
                  >
                    <IconComponent className={`text-${action.color}-600 dark:text-${action.color}-400 group-hover:scale-110 transition-transform`} />
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    <th className="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Test ID</th>
                    <th className="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Patient</th>
                    <th className="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Test Type</th>
