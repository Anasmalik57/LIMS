            ...
            <div className="border-b border-gray-300 p-6 px-0 bg-gradient-to-tl from-blue-300 via-blue-300 to-blue-400">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4 w-full px-2 justify-between">
                  ...
                  <div>
                    <h1 className="text-3xl font-bold text-gray-800 border-2 rounded-sm border-gray-800 px-4 py-1 print:text-2xl">GLOBAL PATHOLOGY LAB</h1>
                  </div>
                  <div className="*:font-semibold">
                    <p className="text-red-600 text-sm font-semibold mt-1">Shekhpuri Roorkee, Haridwar (U.K)</p>
